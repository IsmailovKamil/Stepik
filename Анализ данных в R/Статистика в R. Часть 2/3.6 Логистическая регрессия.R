...
fit2 = glm(admit ~ rank*gpa, data, family = "binomial")
summary(fit2)

data$prob = predict(object = fit2, newdata = data, type = "response")
data$pred = ifelse(data$prob >= 0.4, 2, 1)
